...
void test_validate_my_username()
{
     ...
     */
    T const char* expected_username = my_username();
    ...
    TEST_ASSERT_EQUAL_STRING_MESSAGE(expected_username, actual_username, "Username from config file does not match hardcoded username.");
